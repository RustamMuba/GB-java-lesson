...
public class ExampleTest extends AbstractTest {
    ...
    void getExampleTest() {
        given()
            .when()
            .get(getBaseUrl()+"recipes/716411/information?" +
        ...
        given()
            .when()
            .request(Method.GET,getBaseUrl()+"recipes/716411/information?" +
    ...
    void getSpecifyingRequestDataTest() {
        ...
        given()
            .when()
            .get(getBaseUrl()+"recipes/{id}/information?" +
                "includeNutrition={Nutrition}&apiKey={apiKey}",716411, false, getApiKey())
            .then()
            .statusCode(200);
        ...
        given()
            .queryParam("hash", "cae34950dff14b7ca5f71fa04e491610")
            .queryParam("apiKey", getApiKey())
            .body("{\n"
                + " \"date\": 1644881179,\n"
                + " \"slot\": 1,\n"
    ...
    void getVerifyingResponseData(){
        ...
        JsonPath response = given()
            ...
            .queryParam("includeNutrition", "false")
            .when()
            .get("https://api.spoonacular.com/recipes/716411/information")
            .body()
            .jsonPath();
